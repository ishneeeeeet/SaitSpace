...
function ShareExperience() {
  ...
  async function submit() {
    console.log(name, profile, program, company, position, salary, experience, interview)
    let data = {
      name,
      profile,
      program,
    ...
    const response = await fetch('https://saitspace-service.onrender.com/create', {
      method: 'POST',
  ...
  return (
    <div className="my-10 m-10 mt-2">
      <p className="text-lg mb-2 font-semibold text-gray-800">Your hiring experience</p>
                ...
                <div className="grid grid-cols-6  gap-2">
                  ...
                  <div className="col-span-6">
                    ...
                    <Textarea value={experience}
                      onChange={(e) => setexperience(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-800 focus:ring-red-700 sm:text-sm" />
                  </div>
                  <div className="col-span-6">
                    <p className="text-sm font-medium text-gray-700">Hiring Experience</p>
                    <p className="text-xs font-medium text-gray-700">How did you get an interview?</p>
                    <p className="text-xs font-medium text-gray-700">How did you apply?</p>
                    <label htmlFor="interview" className="block text-xs font-medium text-gray-700">
                      How was the interview experience?
                    </label>
                    <Textarea value={interview}
                      onChange={(e) => setinterview(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-800 focus:ring-red-700 sm:text-sm" />
                  </div>
                </div>
              </div>

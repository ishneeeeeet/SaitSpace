...
const navigation = [
  { name: 'Linkedin Program Search', href: '#', current: false },
  { name: 'Find Your Program', href: '/', current: false },
  { name: 'Share Your Hiring Experience', href: '/shareexperience', current: false },
  { name: 'Latest Experience', href: '/latestexperience', current: false },
]
...
export default function Navbar() {
  return (
    <Disclosure as="nav" style={{ backgroundColor: "#a6192e" }}>
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <p className='text-3xl text-white'>SAIT</p><p className='text-3xl text-blue-300'>Space</p>
                </div>
